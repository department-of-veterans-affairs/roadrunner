...
RSpec.configure do |config|
  ...
  # Database_cleaner configurations
  ...
  # Causes database_cleaner to start before each test
  config.before(:each) do
    DatabaseCleaner.start
  end

  # Causes database_cleaner to clean database with selected strategy after
  # each test
